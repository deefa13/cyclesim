...
//
// A simple command line Power Receiver app built on top of the ANT library that
// receives power data compliant with the required ANT+ specifications.
////////////////////////////////////////////////////////////////////////////////

int main(int argc, char **argv)
{
	printf("********************************************************\n");
	printf("ANT+ Power Receiver application\n");
	printf("********************************************************\n");

	PWRReceiver* Receiver = new PWRReceiver();
	...
	if (argc > 1)			//argc is count of arguments pass to process command line arguments
	{
...
////////////////////////////////////////////////////////////////////////////////
// PWRReceiver (Power Receiver)
//
// Constructor, intializes PWRReceiver class
//
////////////////////////////////////////////////////////////////////////////////
PWRReceiver::PWRReceiver()
{
...
// Init
//
// Initize the PWRReceiver and ANT Library.
//
...
////////////////////////////////////////////////////////////////////////////////
BOOL PWRReceiver::Init(UCHAR ucDeviceNumber_)
{
	...
	uiDSIThread = DSIThread_CreateThread(&PWRReceiver::RunMessageThread, this);
	assert(uiDSIThread);
...
//
////////////////////////////////////////////////////////////////////////////////
DSI_THREAD_RETURN PWRReceiver::RunMessageThread(void *pvParameter_)
{
	((PWRReceiver*)pvParameter_)->MessageThread();
	return NULL;
}
...
// Run message thread
////////////////////////////////////////////////////////////////////////////////
void PWRReceiver::MessageThread()
{
...
// usSize_:
////////////////////////////////////////////////////////////////////////////////
void PWRReceiver::ProcessMessage(ANT_MESSAGE stMessage, USHORT usSize_)
{
	BOOL bStatus;
...
//
////////////////////////////////////////////////////////////////////////////////
void PWRReceiver::DetectDevice(UCHAR &ucDeviceType_, BOOL &bOldToggleBit_, UCHAR &ucToggleAttempts_, BOOL bToggleBit)
{
